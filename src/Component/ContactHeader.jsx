...
const ContactHeader = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-screen">
      <div className="flex flex-col md:flex-row md:justify-evenly justify-center items-center w-full h-full gap-10">
        <div className="mt-20 md:flex md:flex-col md:h-[50%] gap-2">
        ...
        <div className="flex flex-col justify-center items-center rounded-xl border p-9 w-[80%] gap-10 md:w-[40%]">
          <div>
            <h1 className="text-xl font-semibold">
              Send us <span className="text-orange-500">a</span> Message
            </h1>
          </div>
